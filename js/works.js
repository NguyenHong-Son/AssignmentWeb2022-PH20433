const contentList = [
    {
        id: 1,
        img: "https://res.cloudinary.com/freelencer/image/upload/c_scale,h_180,w_246/v1654681377/ASSIGNMENT-WEB2022/SharedScreenshot_dxcabm.jpg",
    ...
    {
        id: 2,
        img: "https://res.cloudinary.com/freelencer/image/upload/v1654681593/ASSIGNMENT-WEB2022/SharedScreenshot_dqn2wn.jpg",
    ...
    {
        id: 3,
        img: "https://res.cloudinary.com/freelencer/image/upload/v1654682403/ASSIGNMENT-WEB2022/SharedScreenshot_wzvfa2.jpg",
    ...
    {
        id: 4,
        img: "https://res.cloudinary.com/freelencer/image/upload/v1654605011/ASSIGNMENT-WEB2022/Rectangle_40_pugyhp.png",
        title: "Components",
        year: 2018,
    ...
    for(let i = 0 ; i < Contents.length; i++){
        ...
        <div class="md:flex md:space-x-5 border-b-[3px] py-5">
          <div class="">
            <img
              src="${content.img}"
              alt="" class="md:max-w-[246px] md:min-h-[180px] max-w-[
            339px] min-h-[
            230px] mx-auto md:mx-0">
          </div>
